...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_GRV,         KC_BSLS,      KC_LALT,KC_LGUI,KC_LANG2,
                                              ALT_T(KC_APP),  KC_ESC,
                                                              KC_HOME,
                                               KC_SPC,KC_LCTL,LGUI(LSFT(KC_RBRC)),
        // right hand
             ...
             TG(MDIA),    KC_N,   KC_M,      KC_COMM,KC_DOT, KC_SLSH,  KC_RSFT,
                                  KC_LANG1,  KC_RGUI, KC_LBRC,KC_RBRC,  KC_GRV,
             LGUI(LSFT(KC_LBRC)), KC_DEL,
             KC_PGUP,
             LGUI(LSFT(KC_LBRC)),KC_BSPC, KC_ENT
    ),
